...
namespace stool
{
    ...
    using ___PermutationTree = bptree::BPTree<bptree::PermutationContainer, bptree::PermutationItem, bptree::DEFAULT_MAX_DEGREE_OF_INTERNAL_NODE, bptree::PermutationContainer::___PermutationLeafSize, true, false>;
    ...
    {
        using BPTree = BPTree<bptree::PermutationContainer, bptree::PermutationItem, bptree::DEFAULT_MAX_DEGREE_OF_INTERNAL_NODE, bptree::DEFAULT_MAX_COUNT_OF_VALUES_IN_LEAF, true, false>;
        if (is_leaf)
        {
