...
void bptree_prefix_sum_test(uint64_t item_num, uint64_t max_value, uint64_t query_num, uint64_t seed)
{
...
int main(int argc, char *argv[])
{
    ...
    bptree_prefix_sum_test(item_num, max_value, query_num, seed);
